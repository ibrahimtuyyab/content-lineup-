...
const targets = [
  {
    id: 'default',
    kicker: 'AI writing + real scheduling',
    title: 'Write it today. Publish it next Thursday at 9 AM.',
    sub: 'SEO-ready articles with matched images, published on your schedule and shared to LinkedIn, Facebook and Instagram.',
  },
  {
    id: 'features',
    kicker: 'Features',
    title: 'Everything between “I should write about that” and “it is live.”',
    sub: 'One queue: drafts, images, alt text, SEO fields, publish times, and social distribution.',
  },
  {
    id: 'pricing',
    kicker: 'Pricing',
    title: 'Free on your own key. $29 if you would rather not have one.',
    sub: 'Every feature on every plan. No article cap on bring-your-own-key.',
    tone: 'sched',
  },
  {
    id: 'why',
    ...
    sub: 'Articles, images, SEO and LinkedIn/Facebook/Instagram from one queue — and where rivals still win.',
  },
  {
    id: 'security',
  ...
  },
  {
    ...
    sub: 'Agencies, local business, SaaS, real estate, e-commerce, coaches and more.',
  },
  {
    id: 'resources',
    kicker: 'Resources',
    title: 'Guides, case studies and comparisons — with the numbers in them.',
    sub: 'Real workflows, real costs, real before-and-after figures.',
    tone: 'sched',
  },
  ...posts.map((p) => ({
    id: p.slug,
